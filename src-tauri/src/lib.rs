...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::trade_system::propose_trade_system_revision_cancelable,
            commands::trade_system::cancel_llm_request,
            ...
            commands::agent_patch::save_agent_patch_proposal,
            commands::agent_patch::list_agent_patch_proposals,
            commands::agent_patch::accept_agent_patch_ops,
            commands::agent_patch::reject_agent_patch_ops,
